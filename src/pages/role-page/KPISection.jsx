...
const KPISection = ({
    ...
    const GenerateRow = ({kpi}) => {
        const subTaskId = kpi?.id
        const editStatus = kpi?.attributes?.status
                            ...
                            <tr className="border-b border-gray-200">
                                ...
                                <td className="px-4 py-5 w-44">
                                    <FormInput
                                        type="text"
                                        name="formula"
                                        formValues={{name: newRow.formula}}
                                        onChange={({target: {name, value}}) => handleFormChange(name, value, true)}
                                    />
                                </td>
                                <td className="px-4 py-5 w-44">
                                    <FormInput
                                        ...
                                        formValues={{name: newRow.evaluationCriteria}}
                                        onChange={({target: {name, value}}) => handleFormChange(name, value, true)}
                                    />
                                </td>
                                <td className="px-4 py-5 w-44">
                                    <FormInput
                                        type="text"
                                        name="targetMetrics"
                                        formValues={{name: newRow.targetMetrics}}
                                        onChange={({target: {name, value}}) => handleFormChange(name, value, true)}
                                    />
                                </td>
                                <td className="px-4 py-5">
